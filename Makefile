...
schirokauer.so: schirokauer.c
	$(CC) -o schirokauer.so schirokauer.c

schirokauer.c: schirokauer.pyx
	$(CYTHON) -3 schirokauer.pyx

schirokauer.pyx: schirokauer.sage.py
	cp schirokauer.sage.py schirokauer.pyx

schirokauer.sage.py: schirokauer.sage
	$(SAGE) -preparse schirokauer.sage
...
smooth_ideal_sqrt_sat.so: smooth_ideal_sqrt_sat.c
	$(CC) -o smooth_ideal_sqrt_sat.so smooth_ideal_sqrt_sat.c

smooth_ideal_sqrt_sat.c: smooth_ideal_sqrt_sat.pyx
	$(CYTHON) -3 smooth_ideal_sqrt_sat.pyx

smooth_ideal_sqrt_sat.pyx: smooth_ideal_sqrt_sat.sage.py
	cp smooth_ideal_sqrt_sat.sage.py smooth_ideal_sqrt_sat.pyx

smooth_ideal_sqrt_sat.sage.py: smooth_ideal_sqrt_sat.sage
	$(SAGE) -preparse smooth_ideal_sqrt_sat.sage
...
lattices.so: lattices.c
	$(CC) -o lattices.so lattices.c

lattices.c: lattices.pyx
	$(CYTHON) -3 lattices.pyx

lattices.pyx: lattices.sage.py
	cp lattices.sage.py lattices.pyx

lattices.sage.py: lattices.sage
	$(SAGE) -preparse lattices.sage
...
clean:
	...
	rm -f smooth_ideal_sqrt_sat.so smooth_ideal_sqrt_sat.c smooth_ideal_sqrt_sat.pyx
	...
	rm -f schirokauer.so schirokauer.c schirokauer.pyx
	rm -f sunits.so sunits.c sunits.pyx
	rm -f idealprod.so idealprod.c idealprod.pyx
	rm -f lattices.so lattices.c lattices.pyx
